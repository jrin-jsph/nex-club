 ...
 */
public class CopyOfAdminDashboard4 {
    ...
    public CopyOfAdminDashboard4(JFrame parentFrame, String loggedInNid) { 
    ...
    private void prepareTables() {
        ...
        try (Statement st = dbConn.createStatement()) {
            ...
            // The 'login' table is assumed to exist and is not created or modified here.
